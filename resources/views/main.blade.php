...
<nav class=" fixed shadow-md w-1/5 h-full py-6 px-5 flex flex-column gap-4">
    ...
    <div class="">
        ...
        <div class="flex gap-2 items-center cursor-pointer">
            <div class="h-4 w-1.5 rounded-2xl bg-black opacity-0"></div>
            <img width="20" height="20" src="https://img.icons8.com/material-two-tone/24/duplicate.png" alt="duplicate" class="opacity-70" />
            <p>Create Project</p>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="">
            ...
            <div class="flex gap-2 items-center bg-gray-100">
...
<main class="pl-4 pt-2.5">
    <div class="flex h-max w-full items-center justify-between pr-4 mb-2 ">
        ...
        <div class="flex gap-2">
            <img width="24" height="24" src="https://img.icons8.com/material-two-tone/24/insert-row-below.png" alt="insert-row-below" class="opacity-70" />
            <div class="w-1 h-5 bg-gray-200 rounded-2xl"></div>
            <img width="24" height="24" src="https://img.icons8.com/material-two-tone/24/bell--v1.png" alt="bell--v1" class="opacity-70" />
        </div>
    </div>
    ...
    <div class="w-full flex justify-between pr-8 ml-3">
        <div class="flex gap-2 items-center w-max">
            ...
            <div class="border border-gray-400 rounded-2xl flex items-center gap-2 text-sm px-2 py-0.5 text-gray-400">
    ...
    <div class="h-full w-full flex justify-around mt-9">
        <div class="border rounded-lg h-full p-2">
            ...
            <div class="w-full bg-gray-200 rounded-xl py-2">
                <div class="rounded-xl m-2 p-3 bg-white w-72" id="card">
                    ...
                    <p class="w-full text-gray-500 my-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis, ratione!</p>
